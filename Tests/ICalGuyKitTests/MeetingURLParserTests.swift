...
final class MeetingURLParserTests: XCTestCase {
    ...
    func testGoogleMeetURL() {
        let result = parser.extractMeetingURL(url: nil, location: nil, notes: "https://meet.google.com/abc-defg-hij")
    ...
    func testZoomURL() {
        let result = parser.extractMeetingURL(url: nil, location: nil, notes: "https://us02web.zoom.us/j/1234567890")
    ...
    func testZoomPlainDomain() {
        let result = parser.extractMeetingURL(url: nil, location: nil, notes: "https://zoom.us/j/9876543210")
    ...
    func testWebExMeetURL() {
        let result = parser.extractMeetingURL(url: nil, location: nil, notes: "https://company.webex.com/meet/jsmith")
    ...
    func testNoMatchReturnsNil() {
        let result = parser.extractMeetingURL(url: nil, location: "Conference Room B", notes: "Bring your laptop")
        XCTAssertNil(result)
    }
    ...
    func testNonMeetingURLReturnsNil() {
        let result = parser.extractMeetingURL(url: "https://example.com/page", location: nil, notes: nil)
        XCTAssertNil(result)
    }
}
